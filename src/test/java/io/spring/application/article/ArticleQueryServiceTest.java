...
public class ArticleQueryServiceTest {
    ...
    public void setUp() {
        ...
        article = new Article("test", "desc", "body", new String[]{"java", "spring"}, user.getId(), LocalDateTime.now());
    ...
    public void should_get_default_article_list() {
        Article anotherArticle = new Article("new article", "desc", "body", new String[]{"test"}, user.getId(), LocalDateTime.now().minusHours(1));
